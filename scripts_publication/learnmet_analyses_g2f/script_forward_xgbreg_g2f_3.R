...
saveRDS(METdata_G2F_training,file='~/results_benchmarking_g2f/METData_training_fw_3.RDS')
...
saveRDS(METdata_G2F_new,file='~/results_benchmarking_g2f/METData_test_fw_3.RDS')
...
results_list <- predict_trait_MET(
  ...
  seed = 100,
  save_processing = T,
  path_folder = '~/results_benchmarking_g2f/results_g2f_forward_3/xgb'
)
...
results_list <- met_pred
fitted_split <- results_list$list_results[[1]]

variable_importance_split(object = fitted_split,
                 path_plot  = '~/results_benchmarking_g2f/results_g2f_forward_3/xgb',
                 type='model_specific')
...
learnMET::ALE_plot_split(fitted_split, 
               path_plot = '~/results_benchmarking_g2f/results_g2f_forward_3/xgb', 
               variable ='freq_P_sup10_2',nb_bins=6)
