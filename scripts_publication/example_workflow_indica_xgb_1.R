...
rescv0_2 <- predict_trait_MET_cv(
  ...
  compute_vip = T,
  seed = 100,
  path_folder = '~/scripts/INDICA/xgb_reg_1/cv0'
)
...
saveRDS(rescv0_2,
        '~/scripts/INDICA/xgb_reg_1/cv0/rescv0_gy.RDS')
...
print(end_time - start)
saveRDS(rescv0_3,
        '~/scripts/INDICA/xgb_reg_1/cv0/rescv0_phr.RDS')
...
print(end_time - start)
saveRDS(rescv0_4,
        '~/scripts/INDICA/xgb_reg_1/cv0/rescv0_gc.RDS')
