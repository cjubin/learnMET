...
params:
  ...
  path: 
    value: '~/Data/PackageMLpredictions/learnmet_plus/bglr_g2f_fw/fw1'
...
library(dplyr)
env_data_training <- readRDS('~/Data/PackageMLpredictions/learnmet_plus/benchmarking_g2f/METData_training_fw_1.RDS')$env_data
env_data_test <- readRDS('~/Data/PackageMLpredictions/learnmet_plus/benchmarking_g2f/METData_test_fw_1.RDS')$env_data
