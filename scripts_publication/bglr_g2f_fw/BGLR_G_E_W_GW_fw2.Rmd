...
params:
  ...
  path: 
    value: '/home/uni08/jubin1/Data/PackageMLpredictions/learnmet_plus/bglr_g2f_fw/fw2'
...
training = phenos[which(phenos$year%in%c(2014,2015)),]
test = phenos[which(phenos$year%in%c(2016)),]
...
library(dplyr)
env_data_training <- readRDS('/home/uni08/jubin1/Data/PackageMLpredictions/learnmet_plus/benchmarking_g2f/METData_training_fw_2.RDS')$env_data
env_data_test <- readRDS('/home/uni08/jubin1/Data/PackageMLpredictions/learnmet_plus/benchmarking_g2f/METData_test_fw_2.RDS')$env_data
