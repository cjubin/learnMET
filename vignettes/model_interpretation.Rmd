...
METdata_G2F_training <-
  create_METData(
    ...
    path_to_save = "/home/uni08/jubin1/Data/PackageMLpredictions/learnmet_plus/benchmarking_g2f/results_g2f_forward_3"
  )
...
```{r vip with permutations, warning=FALSE}
learnMET::variable_importance_split(object = fitted_split,
                                    path_plot  = '~/g2f/res_xgb/cv0',
                                    type = 'model_agnostic')
```
