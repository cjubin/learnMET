#' Predict method for rf_reg_2 objects.
#' Obtains predictions from a training/test split object, pre-processed
#' with [rf_reg_2()].
#' 
#' @description 
#' Fit a gradient boosted trees model on an object of class `rf_reg_2`.
...
#' test set. 
#' 
#' @param object an object of class `rf_reg_2`
#' 
...
#' @name fit_cv_split
#' @export
fit_cv_split.rf_reg_2 <- function(object,
                                   seed,
                                   inner_cv_reps = 1,
                                   inner_cv_folds = 5,
                                   compute_vip = F,
