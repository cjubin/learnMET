#' Predict method for rf_reg_1 objects.
#' Obtains predictions from a training/test split object (with observed
#' values for the test set --> assessment metrics directly calculated), 
#' pre-processed with [rf_reg_1()].
#' 
#' @description 
...
#' test set. 
#' 
#' @param object an object of class `rf_reg_1`
#' 
...
#' @name fit_cv_split
#' @export
fit_cv_split.rf_reg_1 <- function(object,
                                   seed,
                                   inner_cv_reps = 1,
                                   inner_cv_folds = 5,
                                   save_model = F,
  ...
  res_fitted_split <- structure(
    ...
    class = c('res_fitted_split',fitted_rf_reg_1)
  )
...
#' @rdname fit_split
#' @export
fit_split.rf_reg_1 <- function(object,
                                  seed,
                                  inner_cv_reps = 1,
                                  inner_cv_folds = 5,
                                  save_model = F,
