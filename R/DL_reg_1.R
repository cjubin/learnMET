...
#' a `DL_reg_1` (neural network) regression model.
#'
#' @description
...
#'
#' @return A `list` object of class `DL_reg_1` with the following items:
#'   \describe{
...
#' @name DL_reg_1
#' @export
new_DL_reg_1 <- function(split = NULL,
                         trait = NULL,
                         geno = NULL,
                         env_predictors = NULL,
...
#' @rdname DL_reg_1
#' @aliases new_DL_reg_1
#' @export
DL_reg_1 <- function(split,
                     trait,
                     geno,
                     env_predictors,
                     info_environments,
