...
#' a `rf_reg_2` (random forest) regression model.
#'
#' @description
...
#' function [fit_cv_split.rf_reg_2()])).
#'
#'
...
#'
#' @return A `list` object of class `rf_reg_2` with the following items:
#'   \describe{
...
#' @name rf_reg_2
#' @export
new_rf_reg_2 <- function(split = NULL,
                          trait = NULL,
                          geno = NULL,
                          env_predictors = NULL,
...
#' @rdname rf_reg_2
#' @aliases new_rf_reg_2
#' @export
rf_reg_2 <- function(split,
                      trait,
                      geno,
                      env_predictors,
                      info_environments,
