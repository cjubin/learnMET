...
#' a `xgb_reg_2` (gradient boosted tree) regression model.
#'
#' @description
...
#'
#' @return A `list` object of class `xgb_reg_2` with the following items:
#'   \describe{
...
#' @name xgb_reg_2
#' @export
new_xgb_reg_2 <- function(split = NULL,
                          trait = NULL,
                          geno = NULL,
                          env_predictors = NULL,
...
#' @rdname xgb_reg_2
#' @aliases new_xgb_reg_2
#' @export
xgb_reg_2 <- function(split,
                      trait,
                      geno,
                      env_predictors,
                      info_environments,
