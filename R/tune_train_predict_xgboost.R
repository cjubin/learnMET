...
tune_train_predict_xgboost <- function(training_set,test_set,inner_nb_folds = 2,inner_reps = 1,bayesian_optimization = T, grid_search_optimization = F, trait = trait){
